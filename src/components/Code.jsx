  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-secondary/20 ring-1 ring-inset ring-secondary/20 text-white'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-secondary transition duration-300',
          !copied && 'translate-y-1.5 opacity-0',
        )}
      >
        Copied!
